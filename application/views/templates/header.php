...
if( $this->session->userdata('islogin') == "Logged In"){
   // redirect('Login');
}else{
   redirect('/login');
}
...
<html lang="en"><head>
  ...
  <body class="app sidebar-mini  pace-done" style=""><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="transform: translate3d(100%, 0px, 0px);">
